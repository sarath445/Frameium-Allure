...
import static com.frameium.pageobject.UFS.IBHomePage.copytoWord2;
//import static com.frameium.pageobject.UFS.IBHomePage.copytoWord;
...
//				System.out.println("total violations are ................" +totalViolation);
    ...
    public void afterTest() throws Exception{
      // String allureReportEnabled = "yes";
        copytoWord2();
        if (allureReportEnabled != null && allureReportEnabled.equalsIgnoreCase("yes")) {
            String htmlTable = "<table border='1' style='border-collapse: collapse;'>"
                    + "<thead>"
                    + "<tr><th>Test Step</th><th>Result</th></tr>"
                    + "</thead>"
                    + "<tbody>"
                    + "<tr><td>Step 1: Open the website</td><td>Passed</td></tr>"
                    + "<tr><td>Step 2: Perform action</td><td>Passed</td></tr>"
                    + "<tr><td>Step 3: Verify result</td><td>Failed</td></tr>"
                    + "</tbody>"
                    + "</table>";

            // Attach the HTML table to the Allure report
          Allure.addAttachment("Test Steps Table", "text/html", htmlTable);

           GenericFunctions.genAllurereport();


//GenericFunctions.customizeAllureReport();
        ...
        //GenericFunctions.openCmdPromptAndRunAllureServe();
    }
    /**
...
//            String screenshotPath = "D:\\frameium\\Frameium_allure\\target\\screenshots\\" + result.getMethod().getMethodName() + ".png";
...
//            setUp.baseTest.onDemandTakeScreenshot("<<<<< >>>>>");
    ...
    public void beforeScenario(Scenario scenario) {
        ...
        //Allure.addAttachment("Environment", "Staging");
...
//	    Thread.sleep(1000);
    ...
    public static void screen(Scenario scenario) {
        try {
            ...
            String savePath = System.getProperty("user.dir") +"\\frameium\\Frameium_allure\\ExtentReportsnew\\full_screenshot.png";
            ...
            byte[]bytedata=T24.fileToBytes(savePath);
            Path path = Path.of(savePath);
            final byte[] screenshott = Files.readAllBytes(path);
            scenario.attach(screenshott, "image/png", "full_screenshot.png");
    ...
    public static void screenNew1(Scenario scenario) {
        try {
            String name="Checking client maintanance SIT IBM";
            // Take a screenshot of the web page
            File screenshot = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
            ...
            String screeshotname=name+".png";
          //  String screeshotname="Screen.png";
            // Save the full-screen capture
            String savePath = "D:\\frameium\\Frameium_allure\\ExtentReportsnew\\"+screeshotname;
            File screenshotFile = new File(savePath);
            ImageIO.write(screenFullImage, "png", screenshotFile);

            System.out.println("Full screenshot taken and saved as: " + savePath);

            // Assuming T24homepage class has a method fileToBytes that converts file to byte array
            T24homepage T24 = new T24homepage();
            ...
            scenario.attach(byteData, "image/png", "full_screenshot.png");

        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    public static void screenNew(Scenario scenario) {
        try {
    ...
    public static void screenNew2(Scenario scenario) {
        try {
            String name="Checking client maintanance UAT IBM";
            // Take a screenshot of the web page
            File screenshot = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
